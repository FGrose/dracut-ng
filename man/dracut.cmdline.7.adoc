...
in the system. The command: `mount -o remount,size=<nbytes> /run` may be used
...
+
--
* The parameter with no or any of the filesystem related or *_<sizeGiB>_*
...
* *PROMPTFS* may be entered to invoke an interactive dialog to select the
...
rd.live.overlay.overlayfs:: rd.overlay

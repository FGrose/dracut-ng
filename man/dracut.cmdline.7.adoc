...
**rd.live.image**[=__esp[=<sizeMiB>__][,{iso|ciso}]]::
...
supplied without a *_<devspec>_* argument, a comma—`,`—should precede or follow
all these arguments to indicate that *_<devspec>_* is specified elsewhere.
+

...
**rd.live.overlay=**{[__<fstype>__[,__<devspec>__[:{__<pathspec>__|auto}]]]|none}::
...
*_<fstype>_* for a new partition may be [*btrfs*|*ext*[*432*]|*xfs*];
the default is *ext4* for maximum availability, although *btrfs* may

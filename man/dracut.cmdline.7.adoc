...
**iso-scan/filename=**[{__<devspec>__|PROMPTPT}:]{__<filepath>__|PROMPTDR=__<dirpath>__}::
    ...
    *_{`block:|UUID=|PARTUUID=|LABEL=|PARTLABEL=`}_*
...
_dmsquash-live_ and _overlayfs_ modules.
...
+
The creation of a new OverlayFS overlay can be specified by including a new
**rd.live.dir=**__<dirname>__ on the kernel commandline.
...
**rd.live.overlay=**{[{__<size>__|PROMPTSZ}[,{__<fstype>__|PROMPTFS}[,recreate[=__<devspec>__][,__<devspec>__[:{__<pathspec>__|auto}[,ea=__<extra_attr__,__s>__]]]]]]|none}::

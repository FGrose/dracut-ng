...
<<<<<<< HEAD
**rd.overlay=**{[__<fstype>__[,__<devspec>__[:{__<pathspec>__|auto}[,ea=__<extra_attr__,__s>__]]]]|none}::
=======
**rd.live.overlay=**{[{__<sizeGiB>__|PROMPTSZ}[,__<fstype>__[,recreate[=__<devspec>__][,__<devspec>__[:{__<pathspec>__|auto}[,ea=__<extra_attr__,__s>__]]]]]]|none}::
>>>>>>> 00c37d97 (feat(dmsquash-live): enable persistence partition size specification)

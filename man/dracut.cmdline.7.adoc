...
**rd.overlayfs=**{1|[__<devspec>__[:__<pathspec>__]]|0|no|off}::
...
**rd.ovl.dir=**__<path>__ on the kernel commandline.
...
**rd.live.dir={**__<path>__|PROMPT}::
* *_<path>_* specifies the directory within the boot device where the
...
a new **rd.live.dir=**__<path>__ on the kernel commandline.
...
*PROMPT??* argument.
* *_recreate=_*[_<devspec>_] specify the destruction and recreation of a
...
Requires the dracut 'overlayfs' module. (*rd.live.overlay.overlayfs* is the
legacy symbol for this feature.) +

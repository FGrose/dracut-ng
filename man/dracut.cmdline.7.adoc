...
the base root filesystem partition *root=_<path to blockdevice>_* instead
of *root=live:_<path to blockdevice>_*.
With argument
...
**rd.overlay=**{[{__<sizeGiB>__|PROMPTSZ}[,{__<fstype>__|PROMPTFS}[,new:__<live_dir>__[,recreate[=__<devspec>__][,__<devspec>__[:{__<pathspec>__|auto}[,{iso|ciso}[,ea=__<extra_attr__,__s>__]]]]]]]]|none}::

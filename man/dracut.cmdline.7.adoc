...
+
--
* The parameter with no or just the filesystem related arguments specifies the
creation of a persistence partition for the overlay in adequate free space at
the end of the **root=**live:__<path to blockdevice>__ disk on its first boot.
Subsequent boots will ignore any filesystem arguments.

...
**rd.overlay=**{[{__<sizeGiB>__|PROMPTSZ}[,{__<fstype>__|PROMPTFS}[,new_pt_for:__<ovl_dir>__[,recreate[=__<devspec>__][,{__<devspec>__|PROMPTPT|PROMPTDK}[:{__<pathspec>__|auto}[,ea=__<extra_attr__,__s>__]]]]]]]|none}::
...
+
* *_<sizeGiB>_* specifies a partition size in gigabytes for the partition. If
...
If *_<sizeGiB>_* is larger than the free space, the free space value will be

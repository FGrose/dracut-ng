...
**rd.live.overlay=**{[{__<sizeGiB>__|PROMPTSZ}[,{__<fstype>__|PROMPTFS}[,new:__<live_dir>__[,recreate=[__<devspec>__][,__<devspec>__[:{__<pathspec>__|auto}[,ciso[,ea=__<extra_attr__,__s>__]]]]]]]]|none}::

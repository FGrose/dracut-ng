...
over the base root filesystem to complete the bootable root filesystem.
...
directory overlay, to complete the bootable root filesystem. In this case, the
dracut 'overlayfs' module is required.
